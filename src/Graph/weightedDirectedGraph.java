...
public class weightedDirectedGraph
{
    ...
    public static void main(String args[])  {
        ...
        Unweighted_UndirectedGraph_2D graph2D = new Unweighted_UndirectedGraph_2D();
        int a =  graph2D.removeStones_NaiveDFS(new int[][]{{1,2},{1,3},{2,3}});

        System.out.println("Distance from 0 =" );

    }

    public weightedDirectedGraph(int v)   // Adjacent list
    {
        this.numVertices = v;
